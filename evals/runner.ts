...
/**
 * Runner principal para la suite de evals del agente de portafolio de Brenda
 *
 * Uso: npm run evals
 */
...
async function main() {
  ...
  console.log(`╔═══════════════════════════════════════════╗`)
  console.log(`║     Portfolio Agent Evals Suite           ║`)
  console.log(`╚═══════════════════════════════════════════╝`)
  ...
  try {
    ...
    console.log(`${colors.dim}   2. Test against production: CHAT_API_URL=https://brendamanrique.com/api/chat npm run evals${colors.reset}`)
    process.exit(1)
  }
