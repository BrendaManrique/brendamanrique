...
export const ARTICLE_KEYWORDS = {
  ...
  'fractal':           ['fractal', 'koch', 'dimensión fractal', 'fractal dimension', 'mole', 'lunar', 'agse'],
  'early-projects':    ['android', 'thesis', 'tesis', 'aquolity', 'water quality', 'calidad del agua', 'project tango', 'blockchain', 'nft'],
  'story':             ['story', 'historia', 'build phase', 'fase de construcción', 'left moody', 'dejó moody'],
}
...
export const ARTICLE_ROUTES = {
  ...
  'fractal':           { page_path_es: '/dimension-fractal', page_path_en: '/fractal-dimension' },
  'early-projects':    { page_path_es: '/proyectos-iniciales', page_path_en: '/early-projects' },
  'story':             { page_path_es: '/historia', page_path_en: '/story' },
}
...
export function classifyIntent(text) {
  ...
  if (/experiencia|experience|trabajo|work|career|carrera|moody|jpmorgan|money\.net/.test(lower)) tags.push('topic:experience')
  ...
  if (/stack|tech|tecnolog|python|react|postgres|aws|claude|ai|ia|llm|agente|agent/.test(lower)) tags.push('topic:technical')
...
export async function sendJailbreakAlert(userMessage) {
  ...
  await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      ...
      subject: '🚨 JAILBREAK ATTEMPT - brendamanrique.com',
      html: `
