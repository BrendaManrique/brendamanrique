 ...
 *   Production: npx tsx scripts/check-console-errors.ts https://brendamanrique.com
 *
...
function getUrls(): string[] {
  ...
  urls.push(`${SITE_URL}/privacidad`, `${SITE_URL}/privacy`)

  // Convert to use the base URL
  return urls.map(url => url.replace(SITE_URL, baseUrl))
}
