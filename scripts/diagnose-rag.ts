...
const ARTICLE_KEYWORDS: Record<string, string[]> = {
  ...
  'fractal': ['fractal', 'koch', 'mole', 'agse', 'classification'],
  'early-projects': ['android', 'thesis', 'aquolity', 'water quality', 'project tango', 'blockchain', 'nft'],
  'story': ['story', 'historia', 'build phase', 'left moody'],
