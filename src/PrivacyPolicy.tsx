...
const content = {
  es: {
    ...
    intro: 'Esta politica describe como se recopilan y utilizan los datos cuando visitas brendamanrique.com.',
    sections: [
      {
        heading: 'Que datos se recopilan',
        items: [
          'Mensajes del chatbot: cuando interactuas con el agente de chat de este sitio (la IA de portafolio de Brenda), los mensajes se procesan para generar respuestas. No se solicita ni almacena informacion personal identificable.',
      ...
      },
      {
        ...
        items: [
          'Los mensajes del chatbot se utilizan exclusivamente para generar respuestas contextuales sobre la experiencia profesional de Brenda.',
      ...
      {
        heading: 'Contacto',
        body: 'No se publica ningun email personal en este sitio. Para cualquier consulta sobre privacidad, puedes escribir por LinkedIn:',
        link: LINKEDIN_URL,
  ...
  en: {
    ...
    intro: 'This policy describes how data is collected and used when you visit brendamanrique.com.',
    sections: [
      {
        heading: 'What data is collected',
        items: [
          "Chat messages: when you interact with this site's chat agent (Brenda's portfolio AI), messages are processed to generate responses. No personally identifiable information is requested or stored.",
      ...
      },
      {
        ...
        items: [
          "Chatbot messages are used exclusively to generate contextual responses about Brenda's professional experience.",
      ...
      {
        heading: 'Contact',
        body: 'No personal email is published on this site. For any privacy-related inquiries, you can reach out on LinkedIn:',
        link: LINKEDIN_URL,
        linkLabel: 'linkedin.com/in/brendastephanie',
      },
    ],
