...
Object.defineProperty(window, '__portfolio', {
  value: Object.freeze({
    ...
    agent: "Brenda's portfolio AI — third person, never roleplays as her",
    retrieval: 'Hybrid: Postgres full-text + pgvector, reciprocal rank fusion',
    guardrails: 'Scope boundaries, input/output checks, tool allowlist, rate limits, online scoring',
...
function NotFound() {
  ...
  useEffect(() => {
    ...
    document.title = `404 — Page not found | ${SITE_NAME}`
