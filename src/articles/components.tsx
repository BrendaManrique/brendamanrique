...
const FOOTER_I18N = {
  es: {
    role: 'Constructora de sistemas de IA agéntica · Ingeniera full-stack y de sistemas financieros',
    bio: 'Más de 15 años construyendo software en producción en finanzas, analítica y sistemas inteligentes. Desde agosto de 2025, en fase de construcción y validación de una práctica de consultoría en IA agéntica.',
    copyright: 'Todos los derechos reservados.',
  },
  en: {
    role: 'Agentic AI Systems Builder · Full-stack and financial-systems engineer',
    bio: '15+ years building production software across finance, analytics and intelligent systems. Since August 2025, in a build and validation phase for an agentic AI consulting practice.',
  ...
  return (
    <footer className="mt-16 pt-8 border-t border-border">
      <div className="flex items-start gap-3 mb-6">
        ...
        />
        <div>
          <p className="font-medium text-foreground">{AUTHOR_NAME}</p>
      ...
      >
        {lang === 'es' ? 'Más sobre la autora →' : 'More about the author →'}
      </Link>
      <div className="flex gap-3 mb-8">
        <a href={LINKEDIN_URL} target="_blank" rel="me noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#0A66C2]/10 border border-[#0A66C2]/20 text-sm font-medium text-[#0A66C2] hover:bg-[#0A66C2]/20 transition-colors">
        ...
        <a href={GITHUB_URL} target="_blank" rel="me noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-card border border-border text-sm font-medium text-muted-foreground hover:text-foreground hover:border-primary/30 transition-colors">
      ...
      <div className="flex items-center gap-3 text-xs text-muted-foreground">
        <span>&copy; {new Date().getFullYear()} {AUTHOR_NAME}. {f.copyright}</span>
