  ...
  return (
    <>
      ...
      <motion.button
        ...
        aria-label={lang === 'en' ? (isOpen ? "Close Brenda's portfolio AI" : "Open Brenda's portfolio AI") : (isOpen ? 'Cerrar la IA de portafolio de Brenda' : 'Abrir la IA de portafolio de Brenda')}
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            role="dialog"
            aria-modal="true"
            aria-label={lang === 'en' ? "Brenda's portfolio AI" : 'IA de portafolio de Brenda'}
